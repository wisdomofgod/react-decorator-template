...
/***/ function(module, exports, __webpack_require__) {
	...
	var react_redux_1 = __webpack_require__(71);
	var store_1 = __webpack_require__(109);
	ReactDOM.render((React.createElement("div", null, 
	    React.createElement(react_redux_1.Provider, {store: store_1.store}, router_1.default)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var home_page_1 = __webpack_require__(68);
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = (React.createElement(react_router_1.Router, {history: react_router_1.hashHistory}, 
	    React.createElement(react_router_1.Route, {path: "/home", component: home_page_1.default})
	));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Connect_1 = __webpack_require__(70);
	...
	exports.Render = function (_a) {
	    ...
	    return function (target, propertyKey, descriptor) {
	            ...
	            switch (typeof template) {
	                ...
	                case "undefined":
	                    if (templateUrl) {
	                        ...
	                        return React.createElement("h1", null, "nothing");
	                    }
	            }
	        };
	        var jsxRender = function () {
	            ...
	            // return render();
	            return function () {
	                return React.createElement("div", null, "Please use string-jsx in the https://github.com/wisdomofgod/string-jsx");
	            };
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var react_redux_1 = __webpack_require__(71);
	exports.Connect = function (mapState, mapDispatch) {
	    var content = function (Component) {
	        var mapStateToProps = (function () {
	            ...
	            return function (state, ownProps) {
	                var obj = Object();
	                mapState.map(function (key, value) {
	                    if (typeof key === "string") {
	                        if (key.indexOf('.') > -1) {
	                            var keys = key.split('.');
	                            var firstKey = keys.shift();
	                            obj[keys[keys.length - 1]] = keys.reduce(function (o, k) {
	                                return o[k];
	                            }, firstKey);
	                        }
	                        else {
	        ...
	        var mapDispatchToProps = (function () {
	            ...
	            return function (dispatch, ownProps) {
	                var obj = Object();
	                mapDispatch.map(function (item) {
	                    var key = Object.keys(item)[0];
	                    obj[key] = function () { return dispatch(item[key]); };
	                });
	                return obj;
	            };
	        })();
	        //利用connect生成UI组件的容器
	        var NewComponent = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(Component);
	        return (function (_super) {
	            ...
	            Content.prototype.render = function () {
	                return React.createElement(NewComponent, null);
	            };
	            return Content;
	        }(React.Component));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var redux_1 = __webpack_require__(78);
	var reducer_1 = __webpack_require__(111);
